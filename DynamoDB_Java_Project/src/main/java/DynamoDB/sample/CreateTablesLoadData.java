...
public class CreateTablesLoadData {
    ...
    static String productCatalogTableName = "ProductCatalogs6";
    static String forumTableName = "Forums6";
    static String threadTableName = "Threads6";
    static String replyTableName = "Replys6";
